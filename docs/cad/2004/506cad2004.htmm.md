...
style="mso-spacerun: yes">  </span>506/2004-CAD<o:p></o:p></span></b></p>
...
<table border=0 cellspacing=0 cellpadding=0 style='border-collapse:collapse;
 ...
 <tr>
  ...
  Técnica, a ser celebrado entre UEM/Cirad/IDR.<o:p></o:p></span></b></p>
  </td>
 </tr>
</table>
...
contido no <b style='mso-bidi-font-weight:normal'>processo nº 1.171/2004</b>;<o:p></o:p></span></p>
...
Termo de Cooperação Técnica, a ser celebrado entre esta Instituição e o Centro
de Cooperação Internacional de Pesquisa Agronômica para o Desenvolvimento
(Cirad)/Instituto para o Desenvolvimento Regional (IDR), objetivando o
estabelecimento de relações de colaboração visando o desenvolvimento no Brasil,
na região de Maringá, Estado do Paraná, do estudo de caso na cadeia de milho
para alimentação animal (aves) dentro das ações 4 (Análise de perigo de
micotoxinas), 5 (identificação e validação de medidas de controle de
micotoxinas) e 6 (Desenvolvimento de um sistema de gestão da qualidade) do
projeto MYCOTOX.<o:p></o:p></span></p>
