...
style='mso-spacerun:yes'>  </span>288/2007-CAD<o:p></o:p></span></p>
...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
  ...
  Parcial de Atividades do Projeto de Prestação de Serviços: Prestação de
  Serviços de Assistência Técnica, Visando a Identificação ou a Quantificação
  de Mercadorias <st1:PersonName ProductID="em Procedimento Fiscal" w:st="on">em
...
ProductID="88 a" w:st="on">88 a</st1:metricconverter> 94 do <b
...
o disposto na Resolução nº 588/96-CAD;</span><span style='font-size:12.0pt;
...
de Prestação de Serviços: Prestação de Serviços de Assistência Técnica, Visando
a Identificação ou a Quantificação de Mercadorias <st1:PersonName
ProductID="em Procedimento Fiscal" w:st="on">em Procedimento Fiscal</st1:PersonName>
junto à Delegacia da Receita Federal de Maringá</b>, executado pelo Gabinete da
Reitoria (GRE), no que se refere ao seu aspecto financeiro, referente ao
período de janeiro a dezembro de 2006.</span><span style='font-family:Arial;
